...
public class ParticleSystem
{
	...
	private void emitParticle(Vector3f center)
	{
		...
		new Particle(new Vector3f(center), velocity, gravityComplient, lifeLength,
	...
	private static Vector3f generateRandomUnitVectorWithinCone(Vector3f coneDirection, float angle)
	{
		...
		if(coneDirection.x != 0 || coneDirection.y != 0 || (coneDirection.z != 1
		                                                    && coneDirection.z != -1))
		{
			Vector3f rotateAxis = Vector3f.cross(coneDirection, new Vector3f(0, 0, 1), null);
			rotateAxis.normalise();
			float rotateAngle = (float) Math
					.acos(Vector3f.dot(coneDirection, new Vector3f(0, 0, 1)));
